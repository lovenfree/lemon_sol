...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler({HttpMessageNotReadableException.class, IllegalArgumentException.class
            , UnrecognizedPropertyException.class, UnexpectedTypeException.class})
    ...
    protected ResponseEntity<ErrorResponse> handleMissingRequestHeaderException(MissingRequestHeaderException e) {
        LOGGER.error("handleBadRequest", e);
        final ErrorResponse response = ErrorResponse.of(ErrorCode.MISSING_REQUEST_HEADER);
        return new ResponseEntity<>(response, HttpStatus.BAD_REQUEST);
    }
    ...
    protected ResponseEntity<ErrorResponse> handleBusinessException(final BusinessException e) {
        ...
        final ErrorResponse response = ErrorResponse.of(errorCode,e.getDetails());
